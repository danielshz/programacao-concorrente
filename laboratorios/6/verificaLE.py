...
class LE:
	...
	def leitorLendo(self, id):
		...
		if self.escritores_bloqueados > 0:
			print("ERRO: leitor " + str(id) + " iniciou uma leitura quando ha escritor esperando")
